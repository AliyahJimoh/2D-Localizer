...
For Python implementation, the 2D Localization software will follow the coding style guidelines outlined in Python Enhancement Proposal 8 (PEP8). To enforce this, the Flake8 linter will be used to ensure that code meets PEP8's guidelines.
...
% To help validate the accuracy of the localization algorithm, 2D Localizer will use the Georgia Tech Smoothing and Mapping (\href{https://github.com/borglab/gtsam}{GTSAM}) library as an external benchmark as they have a state estimation framework that could be used to compare.

Use data sets. Implement/use GTSAM as an API/modelling language with localizer \cite{gtsam2022}
\plt{Please edit this}
