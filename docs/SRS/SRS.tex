...
\item[A\refstepcounter{assumpnum}3 \label{A_indep}:]Each sensor has independent measurements
\item[A\refstepcounter{assumpnum}4 \label{A_noise}:]Sensor noise is zero-mean Gaussian
