...
\\
$\sigma^2_j$ & \si[per-mode=symbol] {\square\metre} & Noise variance for beacon j
\\
\bottomrule
\end{longtable*}
...
& $\mathbf{\hat{x}}$ is the estimated position in \iref{IM_MLE}\\
\hline
...
\noindent \begin{longtable*}{l l l l c} 
  ...
  \\
  \bottomrule
  \multicolumn{5}{l}{\scriptsize * The user will make a set of each input variable.}\\
\end{longtable*}
\end{table}
